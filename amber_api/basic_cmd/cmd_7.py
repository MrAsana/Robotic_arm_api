...
def calibrate(actuator_id,IP_ADDR="127.0.0.1", PORT=26001):
    s = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)  # Standard socket processes
    payloadS = robot_cmd(7, 12, random.randint(0, 2147483647), actuator_id)  # Fill struct for send with numbers
